...
public class DroneSelectAdapter extends BaseAdapter {
    private Context context;
    private int layout;
    private ArrayList<Drone> listDrone;

    public DroneSelectAdapter(Context context, int layout, ArrayList<Drone> listDrone) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null)
        {
            ...
            viewHolder.checkBox = (CheckBox) convertView.findViewById(R.id.checkboxSelect);
    ...
    private void saveDroneSelected(int droneId)
    {
        SharedPreferences sharedPreferences = context.getSharedPreferences("droneSelect", Context.MODE_PRIVATE);
