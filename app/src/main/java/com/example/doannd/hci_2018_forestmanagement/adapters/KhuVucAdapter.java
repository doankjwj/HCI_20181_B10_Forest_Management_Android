...
public class KhuVucAdapter extends ArrayAdapter<District> {
    private Context context;
    // Your custom values for the spinner (User)
    private District[] values;

    public KhuVucAdapter(Context context, int textViewResourceId,
                       District[] values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        label.setText(values[position].getID());
